 ...
 * 不覆盖已存在的文件，不创建 teacher-insight-reviews.json。
 *
 * 用法：
...
var COPY_FILES = [
  { exampleName: 'users.json',                        targetName: 'users.json',                        validate: validateArray },
  { exampleName: 'sessions.json',                     targetName: 'sessions.json',                     validate: validateObject },
  ...
  { exampleName: 'bindings.json',                     targetName: 'bindings.json',                     validate: validateObject },
  { exampleName: 'teacher-binding-invitations.json',  targetName: 'teacher-binding-invitations.json',  validate: validateArray },
  { exampleName: 'teacher-binding-audit.jsonl',       targetName: 'teacher-binding-audit.jsonl',       validate: validateJsonl },
  { exampleName: 'teacher-report-narratives.json',    targetName: 'teacher-report-narratives.json',    validate: validateArray },
  { exampleName: 'teacher-safety-signals.json',       targetName: 'teacher-safety-signals.json',       validate: validateArray },
