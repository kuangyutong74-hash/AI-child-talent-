      ...
      <section className="home-stage">
        <div className="home-copy">
          ...
          <div className="home-actions">
            <Button className="home-main-action" variant="primary" size="lg" data-guide="home-start" onClick={() => navigate("/story-create/characters")}><PngIcon name="action-write" size={40} />开始创作</Button>
          ...
          <button
            className="home-guide-replay"
            onClick={() => {
              resetAll();
              navigate("/story-create/channel");
            }}
          >
            ✨ 重新看引导
          </button>
