...
function makeDataDir(base) {
  ...
  fs.writeFileSync(path.join(d, 'users.json'), '[]', 'utf-8');
  fs.writeFileSync(path.join(d, 'sessions.json'), '{}', 'utf-8');
  fs.writeFileSync(path.join(d, 'history.json'), '[]', 'utf-8');
  fs.writeFileSync(path.join(d, 'bindings.json'), '{}', 'utf-8');
  ...
  fs.writeFileSync(path.join(d, 'teacher-binding-invitations.json'), '[]', 'utf-8');
  fs.writeFileSync(path.join(d, 'teacher-binding-audit.jsonl'), '', 'utf-8');
  fs.writeFileSync(path.join(d, 'teacher-insight-reviews.json'), '{}', 'utf-8');
  return d;
}
